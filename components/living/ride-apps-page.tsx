...
function getFeatures() {
  return [
    iconEnTh(
      ...
      "Цена заранее",
      "确认前显示车费——避免计价器纠纷。",
      "Цена до подтверждения — без споров о счётчике.",
    ),
    iconEnTh(
      MapPin,
      ...
      "精确定位",
      "Точка посадки",
      "海滨路与商场多入口——在 App 留言 Soi 编号。",
      "Beach Road и ТЦ — несколько входов; укажите номер soi.",
    ),
    iconEnTh(
      CreditCard,
      "Cashless preferred",
      ...
      "Безнал",
      "减少找零骗局；过路费仍备现金。",
      "Меньше мошенничества с сдачей; наличные на toll.",
    ),
    iconEnTh(
      UtensilsCrossed,
      "Food delivery",
      ...
      "外卖",
      "Доставка еды",
      "GrabFood 与 Bolt Food 有英文菜单——仲天公寓常用。",
      "GrabFood и Bolt Food с англ. меню — популярно в Jomtien.",
    ),
    iconEnTh(
      Car,
      "Airport & intercity",
      ...
      "机场长途",
      "Аэропорт",
      "提前 2–3 小时订 BKK 或乌塔保；App 固定价优于路边拉客。",
      "BKK или U-Tapao за 2–3 ч; фикс. цена лучше, чем у зазывал.",
    ),
  ];
}
