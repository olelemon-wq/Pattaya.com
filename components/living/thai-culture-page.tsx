...
function getPillars() {
  return [
    iconEnTh(
      ...
      "Sanuk и гармония",
      "生活应有趣；避免公开冲突以保全面子。",
      "Жизнь должна приносить радость; избегайте публичных конфликтов.",
    ),
    iconEnTh(
      Sparkles,
      ...
      "Буддизм в быту",
      "寺庙、行善与平和举止塑造节日与社区节奏。",
      "Храмы, merit-making и спокойствие задают ритм праздников и районов.",
    ),
    iconEnTh(
      Calendar,
      "Festivals",
      ...
      "节庆",
      "Праздники",
      "泼水节、水灯节与本地庙会——芭提雅城与海滩同庆。",
      "Сонгкран, Loy Krathong и ярмарки — город и пляж вместе.",
    ),
    iconEnTh(
      Languages,
      "Language basics",
      ...
      "基础泰语",
      "Основы языка",
      "萨瓦迪、阔昆与ครับ/ค่ะ 处处通行。",
      "Sawasdee, khop khun и khrap/kha открывают двери везде.",
    ),
  ];
}
