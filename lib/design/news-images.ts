...
export const newsImages = {
  /** News hub hero — dawn police / storm Beach Road (local asset) */
  newsHubHero: "/images/news/news-hero-dawn-police.jpg",
  /** Cinematic hero — Pattaya bay at sunset (category pages & spotlights) */
  heroCinematic:
