...
export const barExtendedCopy = {
    ...
    items: [
      {
        ...
        value: L("3–5 months", "3–5 เดือน", "3–5 个月", "3–5 месяцев"),
      },
      {
        label: L("License stack", "ชุดใบอนุญาต", "许可组合", "Стек лицензий"),
        value: L("Trade + alcohol + MCT", "ใบค้า + แอลกอฮอล์ + MCT", "营业 + 酒类 + MCT", "Торговая + алкоголь + MCT"),
      },
      {
        label: L("Sound rules", "กฎเสียง", "噪音规定", "Шум"),
        value: L("District decibel limits", "ขีด decibel ตามเขต", "分区分贝限制", "Лимиты decibel"),
      },
      {
        label: L("Hot zones", "ย่านหลัก", "主要区域", "Зоны"),
        value: L("Walking St, beach clubs", "Walking St, beach club", "Walking St、海滩俱乐部", "Walking St, beach clubs"),
      },
    ],
  },
  legalNotes: {
    ...
    items: [
      L(
        ...
        "ใบบันเทิงและแอลกอฮอล์ต้องตรงเวลา ความจุ และประเภทเพลงจริง",
      ...
      L(
        ...
        "เพื่อนบ้านที่อยู่อาศัยอาจร้องเรียน — ตรวจ buffer โซoning ก่อนเซ็นเช่า",
  ...
  readingPath: {
    ...
    intro: L(
      ...
      "ใช้ลำดับนี้หลังอ่านขั้นตอน compliance ด้านล่าง",
      "阅读下方合规步骤后按此顺序进行。",
    ...
    items: [
      {
        ...
        description: L("Zoning, licenses, sound, and MCT.", "โซoning ใบอนุญาต เสียง และ MCT", "分区、许可、噪音与 MCT。", "Зонирование, лицензии, звук, MCT."),
      },
      {
        label: L("Company registration", "จดทะเบียนบริษัท", "公司注册", "Регистрация"),
        description: L("Entity and lease before entertainment filings.", "นิติบุคคลและเช่าก่อนยื่นบันเทิง", "娱乐许可申请前先设主体与租约。", "Юрлицо и аренда до entertainment."),
      },
      {
      ...
      },
      {
        ...
        description: L("Lobby bars inside licensed hotels.", "ล็obby bar ในโรงแรมมีใบอนุญาต", "持证酒店内大堂酒吧。", "Lobby bars в отелях."),
      },
      {
        label: L("Work permit guide", "คู่มือ work permit", "工作证指南", "Work permit"),
        description: L("Foreign managers and resident DJs.", "ผู้จัดการต่างชาติและ DJ", "外籍经理与驻场 DJ。", "Менеджеры и DJ."),
      },
    ],
  },
  faq: {
    ...
    items: [
      {
        ...
        a: L(
          ...
          "ใช่ — ซ้อนใบค้า แอลกอฮอล์ บันเทิง (ถ้ามี) อย. หากมีอาหาร และ MCT ร้านอาหารอาจไม่ต้องใบบันเทิง",
      ...
      },
      {
        ...
        a: L(
          ...
          "DJ ที่จ้างต้องมีวisa และ work permit สัญญา guest DJ ควรระบุภาษีและลิขสิทธิ์",
      ...
      },
      {
        ...
        a: L(
          ...
          "จด VAT เมื่อถึงเกณฑ์ ใช้ใบเสร็จ POS ถูกต้อง — ตำรวจท่องเที่ยวอาจตรวจ",
      ...
      },
      {
        ...
        a: L(
          ...
          "ชุดใบอนุญาตไนท์ไลฟ์ผิดพลาดง่าย — สำนักงานกฎหมายพัทยารวมหนังสือโซoning MCT และแอลกอฮอล์",
  ...
  servicePoints: {
    ...
    intro: L(
      ...
      "ผู้ประกอบการแทบไม่ยื่นเอง — ที่ปรึกษาประสานเทศบาล สรรพสามิต และลิขสิทธิ์",
    ...
    items: [
      {
        ...
        note: L("Trade and entertainment permits.", "ใบค้าและบันเทิง", "营业与娱乐许可。", "Торговая и entertainment."),
      },
      {
        name: L("Excise Department", "กรมสรรพสามิต", "消费税局", "Excise"),
        note: L("Alcohol license by service type.", "ใบแอลกอฮอล์ตามประเภทการเสิร์ฟ", "按供应类型的酒类许可。", "Алкоголь по типу."),
      },
      {
        name: L("MCT — Music Copyright", "MCT ลิขสิทธิ์เพลง", "MCT 音乐版权", "MCT"),
        note: L("Playback and live performance registration.", "จดเล่นเพลงและดนตรีสด", "播放与现场演出登记。", "Воспроизведение и live."),
      },
    ],
  },
};
...
export const barRelatedExtra = [
  ...
  },
  {
    ...
    blurb: L("Manager and performer visas", "วisa ผู้จัดการและศิลปิน", "经理与表演者签证", "Визы менеджеров"),
  },
  {
    label: L("Tax & legal news", "ข่าวภาษีและกฎหมาย", "税务与法律", "Налоги"),
    blurb: L("Entertainment tax and compliance", "ภาษีบันเทิงและ compliance", "娱乐税与合规", "Entertainment tax"),
  },
];
