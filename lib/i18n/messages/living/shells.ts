...
const shells = {
  ...
  ownership: {
    ...
    subtitle: L(
      "Foreign ownership frameworks and title deeds in Thailand.",
      "กรอบกฎหมายการถือครองสำหรับชาวต่างชาติ",
      "泰国外资持有房产的法律框架。",
      "Правовые рамки для иностранцев.",
    ),
  ...
  healthInsurance: {
    ...
    subtitle: L(
      "International and local health plans for long-term Pattaya residents.",
      "แผนประกันสากลและในประเทศสำหรับผู้อยู่ระยะยาว",
      "芭提雅长期居民的国际与本地医疗保险。",
      "Планы для долгосрочных резидентов.",
    ),
  ...
  driving: {
    ...
    subtitle: L(
      "How to obtain a Thai license and navigate Pattaya traffic laws.",
      "ขั้นตอนขอใบขับขี่และกฎจราจรในพัทยา",
      "如何考取泰国驾照及当地交规。",
      "Как получить права и ПДД Паттайи.",
    ),
  ...
  emergencyGuide: {
    ...
    ctaButton: L("Print checklist", "พิมพ์เช็กลิสต์", "打印清单", "Чеклист"),
  ...
  thaiCulture: {
    ...
    subtitle: L(
      "Festivals, language tips, and social life for expats in Pattaya.",
      "เทศกาล ภาษา และชีวิตสังคมสำหรับชาวต่างชาติ",
      "节日、语言与社交生活入门。",
      "Праздники, язык и социальная жизнь.",
    ),
